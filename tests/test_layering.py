...
ALLOWLIST: Set[str] = {
    ...
    "rt/pipeline/outline_review.py: call input()",
    "rt/pipeline/outline_review.py: import questionary",
    "rt/pipeline/outline_review.py: import rt.telegram",
    "rt/pipeline/outline_review.py: import textual.app",
    "rt/pipeline/outline_review.py: import textual.widgets",
